<template>
<div v-if="isAlertVisible" id="toast-danger" class="flex justify-evenly items-center text-center border border-solid border-gray-300 w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow" role="alert">
